...
<body onresize="sizeCheck();resizePaws();resizeOnWidthChange();closeSelectOnResize()" onscroll="scrollCheckTopButton()" onload="editPageOnload(<?php echo $_GET['id'] ?>)">
    ...
    <div class="animalContainer">
        <div class="animalContainerLeft">
            <div class="animalImgContainer">
                <img class="animalContainerIMG" id="animalContainerIMG" alt="A picture of the animal">
            ...
            <div class="animalInfos">
                <div class="animalInfosSecondContainer">
                    <div class="animalName">
                        ...
                        <img src="IMG/male.png" alt="Male icon" class="animalGenderImage genderMale" onclick="switchGender('m')" id="genderM">
                    ...
                    <br><br>
                    <div class="habitatDiv habitatedit">
        ...
        <div class="animalContainerRight">
            <div class="sliders">
                <div class="sliderDiv">
                    ...
                    <input type="range" value="0" min="0" max="10"  id="sliderCuteness">
                    <div class="rangeInfo">
                ...
                <div class="sliderDiv">
                    ...
                    <input type="range" value="0" min="0" max="10"  id="sliderchildFriendlyness">
                    <div class="rangeInfo">
                        <img src="IMG/rangeInfo.png" alt="Range Info icon">
                        <span></span>
                    </div>
                ...
                <div class="sliderDiv">
                    ...
                    <input type="range" value="0" min="0" max="10"  id="sliderSociability">
                    <div class="rangeInfo">
                        <img src="IMG/rangeInfo.png" alt="Range Info icon">
                        <span></span>
                    </div>
                ...
                <div class="sliderDiv">
                    ...
                    <input type="range" value="0" min="0" max="10"  id="sliderexerciseNeed">
                    <div class="rangeInfo">
                        <img src="IMG/rangeInfo.png" alt="Range Info icon">
                        <span></span>
                    </div>
                ...
                <div class="sliderDiv">
                    ...
                    <input type="range" value="0" min="0" max="10"  id="sliderfurLength">
                    <div class="rangeInfo">
                        <img src="IMG/rangeInfo.png" alt="Range Info icon">
                        <span></span>
                    </div>
                ...
                <div class="sliderDiv">
                    ...
                    <input type="range" value="0" min="0" max="10"  id="sliderDocility">
                    <div class="rangeInfo">
                        <img src="IMG/rangeInfo.png" alt="Range Info icon">
                        <span></span>
                    </div>
        ...
        <div class="modifyButton">
            <button class="fancyButton" id="editDiscardModifications">Módosítások elvetése!</button>
            <button class="fancyButton" onclick="edit()" id="editSaveModifications">Módosítások mentése!</button>
        </div>
    </div>
