...
<head>
    ...
    <link rel="stylesheet" href="CSS/employeeTools.css">
...
<body onresize="sizeCheck();resizePaws();resizeOnWidthChange();closeSelectOnResize()" onscroll="scrollCheckTopButton()" onload="placePaws(); setHeader(); setRegisterHabitat(); setUserDataHabitat(); privilegeChecker(); translate()">
...
<div class="toolCardWrapper">
    <div class="toolCard toolCard1" onclick="window.location.href='create.php'">
        <h2 id="cardNewAnimal">Új állat hozzáadása!</h2>
    </div>
    <div class="toolCard toolCard2" onclick="window.location.href='adoptions.php'">
        <h2 id="cardAdoptions">Örökbefogadások</h2>
    </div>
</div>
