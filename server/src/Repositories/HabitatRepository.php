...
class HabitatRepository extends BaseRepository
{
    protected static string $tableName = 'habitats';
    ...
    public static function deleteOne($data, $requiredAccountType) : string
    {
        ...
        if ($authSuccess == true)
        {
            ...
            HabitatJunctionRepository::deleteHabitatsWhere($id);

            ProvideableHabitatsRepository::deleteHabitatsWhere($id);
